...
class StatusTrayIcon(gobject.GObject):
	...
	def __init__(self, icon, menu=None, show_always=True, parent=None):
		...
		self._ind = appindicator.Indicator("indicator-penguintv",
                              icon,
                              appindicator.CATEGORY_APPLICATION_STATUS)
                              
		self._ind.set_icon(icon)
	...
	def set_visible(self, show):
		if show:
			...
			self._ind.set_status(appindicator.STATUS_PASSIVE)
